...
*文件名：pwm_multiprecision_INTHRC.c
*作  者：AE Team
*版  本：v1.0，编译于iDesigner(v4.2.3.166) + 工具链HRCC(v1.2.0.106)
*日  期：2020/12/17
*描  述：PWM模式计数时钟源选择INTHRC，T21多精度pwm模式，T21_CH0(PA0)和T21_CH1(PA7)输出pwm互补波形，T21_CH2(PB7)输出占空比连续变化的pwm波形
...
void main(void) 
{
    ...
    T21OC = 0x65;        //T21_CH2输出高有效，打开捕捉端口复用功能，PWM时钟源选择INTHRC
    T21PH = 0x03;        //pwm周期
    T21PL = 0xE8;
    T21R0H = 0x01;       //pwm0占空比
    T21R0L = 0x4D;
